        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h5 class="font-16 text-uppercase mt-0 text-white-50">Total <br> Products</h5>
                    <h4 class="font-500">1200</h4>
        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h6 class="font-16 text-uppercase mt-0 text-white-50">Products <br> Percentage</h6>
                    <h4 class="font-500">50%<i class="text-danger ml-2"></i></h4>
                    <span class="peity-donut"
                        data-peity='{ "fill": ["#02a499", "#f2f2f2"], "innerRadius": 28, "radius": 32 }' data-width="72"
                        data-height="72">600/1200</span>
        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h5 class="font-16 text-uppercase mt-0 text-white-50">Sold <br> Today</h5>
                    <h4 class="font-500">50<i class=" text-success ml-2"></i></h4>
                    <span class="peity-donut"
                        data-peity='{ "fill": ["#02a499", "#f2f2f2"], "innerRadius": 28, "radius": 32 }' data-width="72"
                        data-height="72">50/1200</span>
        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h5 class="font-16 text-uppercase mt-0 text-white-50">Sold <br> Yesterday</h5>
                    <h4 class="font-500">100<i class=" text-success ml-2"></i></h4>
                    <span class="peity-donut"
                        data-peity='{ "fill": ["#02a499", "#f2f2f2"], "innerRadius": 28, "radius": 32 }' data-width="72"
                        data-height="72">100/1200</span>
                            ...
                            <div class="col-md-6">
                                <div class="text-center">
                                    ...
                                    <span class="peity-donut"
                                        ...
                                        data-width="72" data-height="72">750/1200</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="text-center">
